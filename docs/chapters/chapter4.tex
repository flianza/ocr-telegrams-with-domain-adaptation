...
\begin{figure}[H]
    ...
    \caption{Representaciones UMAP de los espacios latentes de los modelos LeNet. Los puntos naranjas representan observaciones de MNIST y los azules de TDS.}
