...
\begin{itemize}
    \item Entrenamiento (70\% de cada dataset): utilizado para entrenar la ResNet-18 en cada \'epoca.
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc}
        \toprule
                           & ADDA        & AFN          & DANN        & MDD         & Sin AD      \\
        \midrule
        LR$^{*}$           & [1e-4, 0.1] & [1e-4, 0.1]  & [1e-4, 0.1] & [1e-4, 0.1] & [1e-4, 0.1] \\
        Pretrain LR$^{*}$  & [1e-4, 0.1] & -            & -           & -           & -           \\
        Pretrain Epochs    & [5, 10]     & -            & [0.5, 2]    & [0.5, 2]    & -           \\
...
\subsection{Discrepancia M\'axima Promedio}
