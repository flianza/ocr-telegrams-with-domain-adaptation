...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{chapter2/mnist.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{chapter2/lenet5.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{cccc}
        ...
        {}                                                & MNIST                                             & USPS                              & SVHN                              \\
        Entrenamiento                                     & \includegraphics[width=16px]{chapter2/mnist3.png}
        \includegraphics[width=16px]{chapter2/mnist6.png}
        \includegraphics[width=16px]{chapter2/mnist8.png} & \includegraphics[width=16px]{chapter2/usps3.png}
        \includegraphics[width=16px]{chapter2/usps6.png}
        \includegraphics[width=16px]{chapter2/usps8.png}  & \includegraphics[width=16px]{chapter2/svhn3.png}
        \includegraphics[width=16px]{chapter2/svhn6.png}
        \includegraphics[width=16px]{chapter2/svhn8.png}                                                                                                                              \\
        \midrule
        MNIST                                             & \multirow{2}{*}{\textbf{99.17\%}}                 & \multirow{2}{*}{78.08\%}          & \multirow{2}{*}{31.50\%}          \\
        \includegraphics[width=16px]{chapter2/mnist3.png}
        \includegraphics[width=16px]{chapter2/mnist6.png}
        \includegraphics[width=16px]{chapter2/mnist8.png} &                                                   &                                   &                                   \\
        USPS                                              & \multirow{2}{*}{57.10\%}                          & \multirow{2}{*}{\textbf{95.42\%}} & \multirow{2}{*}{26.94\%}          \\
        \includegraphics[width=16px]{chapter2/usps3.png}
        \includegraphics[width=16px]{chapter2/usps6.png}
        \includegraphics[width=16px]{chapter2/usps8.png}  &                                                   &                                   &                                   \\
        SVHN                                              & \multirow{2}{*}{61.92\%}                          & \multirow{2}{*}{64.28\%}          & \multirow{2}{*}{\textbf{89.52\%}} \\
        \includegraphics[width=16px]{chapter2/svhn3.png}
        \includegraphics[width=16px]{chapter2/svhn6.png}
        \includegraphics[width=16px]{chapter2/svhn8.png}  &                                                   &                                   &                                   \\
        \bottomrule
    \end{tabular}
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.8\textwidth, height=0.3\textheight]{chapter2/transfer-learning.png}
    ...
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        ...
        \draw (150.69,97.71) node [rotate=-45.29,xslant=-1.02] {\includegraphics[width=34.45pt,height=42.06pt]{chapter2/mnist3.png}};
        \draw (150.77,251.82) node [rotate=-44.36,xslant=-0.97] {\includegraphics[width=32.86pt,height=42.51pt]{chapter2/svhn3.png}};
