...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
    ...
    %Shape: Trapezoid [id:dp033671238257944935] 
    ...
    %Rounded Rect [id:dp5451784827501565] 
    ...
    %Rounded Rect [id:dp2387840011551663] 
    ...
    %Shape: Circle [id:dp5434429051639935] 
    ...
    %Shape: Circle [id:dp07620412226976292] 
    \draw  [dash pattern={on 4.5pt off 4.5pt}] (297.2,145.55) .. controls (297.2,137.13) and (304.03,130.3) .. (312.45,130.3) .. controls (320.87,130.3) and (327.7,137.13) .. (327.7,145.55) .. controls (327.7,153.97) and (320.87,160.8) .. (312.45,160.8) .. controls (304.03,160.8) and (297.2,153.97) .. (297.2,145.55) -- cycle ;

    %Shape: Ellipse [id:dp45432698557456797] 
    \draw   (353,124.28) .. controls (353,114.48) and (366.91,106.53) .. (384.06,106.53) .. controls (401.22,106.53) and (415.13,114.48) .. (415.13,124.28) .. controls (415.13,134.09) and (401.22,142.03) .. (384.06,142.03) .. controls (366.91,142.03) and (353,134.09) .. (353,124.28) -- cycle ;
    %Shape: Circle [id:dp32408939453044705] 
    ...
    %Shape: Circle [id:dp4289741736286996] 
    ...
    %Shape: Ellipse [id:dp9642501981304152] 
    ...
    %Straight Lines [id:da7251468171000668] 
    ...
    %Straight Lines [id:da4737451817168479] 
    \draw    (270.33,131.95) -- (295.35,145.34) ;
    \draw [shift={(298,146.75)}, rotate = 208.14] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
    %Straight Lines [id:da7936227455814397] 
    ...
    %Straight Lines [id:da4136337294740495] 
    ...
    %Straight Lines [id:da47096857078265786] 
    \draw    (271.6,51.2) -- (295.42,65.23) ;
    \draw [shift={(298,66.75)}, rotate = 210.5] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
    %Straight Lines [id:da25177767921579974] 
    ...
    %Straight Lines [id:da30663608487448224] 
    ...
    \draw    (182,75.6) -- (218.3,51.65) ;
    \draw [shift={(220.8,50)}, rotate = 146.58] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
    %Straight Lines [id:da7455647779284351] 
    \draw    (184,95.2) -- (217.69,113.38) ;
    \draw [shift={(220.33,114.81)}, rotate = 208.36] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
    %Shape: Circle [id:dp3903278330340414] 
    \draw   (155.8,141.95) .. controls (155.8,133.53) and (162.63,126.7) .. (171.05,126.7) .. controls (179.47,126.7) and (186.3,133.53) .. (186.3,141.95) .. controls (186.3,150.37) and (179.47,157.2) .. (171.05,157.2) .. controls (162.63,157.2) and (155.8,150.37) .. (155.8,141.95) -- cycle ;
    %Straight Lines [id:da6502607141934658] 
    \draw    (186.3,141.95) -- (217.45,132.8) ;
    \draw [shift={(220.33,131.95)}, rotate = 163.63] [fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.08]  [draw opacity=0] (8.93,-4.29) -- (0,0) -- (8.93,4.29) -- cycle    ;
    ...
    \draw (110,85) node   [align=left] {\begin{minipage}[lt]{22.78pt}\setlength\topsep{0pt}
      ...
      \end{minipage}};
    % Text Node
    \draw (312.45,145.55) node   [align=left] {\begin{minipage}[lt]{21.08pt}\setlength\topsep{0pt}
        \begin{center}
          $\mathbf{d}^{\mathbf{n}}$
        \end{center}
    ...
    \draw (313.25,66.75) node   [align=left] {\begin{minipage}[lt]{21.08pt}\setlength\topsep{0pt}
      ...
      \end{minipage}};
    % Text Node
    \draw (383.66,52) node   [align=left] {\begin{minipage}[lt]{32.64pt}\setlength\topsep{0pt}
        \begin{center}
      ...
      \end{minipage}};
    % Text Node
    \draw (170.23,85) node   [align=left] {\begin{minipage}[lt]{21.08pt}\setlength\topsep{0pt}
        \begin{center}
          $\mathbf{z}$
        \end{center}
      ...
      \end{minipage}};
    % Text Node
    \draw (52.65,85) node   [align=left] {\begin{minipage}[lt]{21.08pt}\setlength\topsep{0pt}
        \begin{center}
          $\mathbf{x}$
        \end{center}
      ...
      \end{minipage}};
    % Text Node
    \draw (171.05,142) node   [align=left] {\begin{minipage}[lt]{21.08pt}\setlength\topsep{0pt}
        \begin{center}
          $\mathbf{n}$
        \end{center}
      ...
      \end{minipage}};
    % Text Node
    \draw (384.86,125) node   [align=left] {\begin{minipage}[lt]{32.64pt}\setlength\topsep{0pt}
        \begin{center}
  ...
  \caption[Esquema de una GAN]{Esquema basico una GAN.}
\end{figure}

Inspirada en estas arquitecturas GAN, la Red Neural Adversaria de Dominio {\it DANN} \parencite{ganin2016domain} de tres componentes clave: la generadora de características $\mathcal{G}$, la discriminadora de
