...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption[Histogramas de proporciones de píxeles blancos por voto]{Histogramas de proporciones de píxeles blancos por voto.}
...
El siguiente punto a analizar es el tamaño de las imágenes. Como se mostra en el cuadro
...
registros que se encuentren por fuera de la media mas menos cuatro desvíos estándar.
...
permitir una mayor flexibilidad en el perfeccionamiento, procesamiento y análisis de los mismos en trabajos futuros. La
figura \ref{fig:tds} muestra una previsualizacion del conjunto de datos TDS.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{chapter3/tds.png}
    \caption[Conjunto de datos TDS]{Conjunto de datos TDS.}
    \label{fig:tds}
\end{figure}
