...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Ejemplo del conjunto de datos generado}{Ejemplo de registros del conjutno de datos. Cada fila representa un voto.}
...
\begin{figure}[H]
    ...
    \caption{Dataset TDS de dígitos}{Dataset TDS de dígitos.}
    \label{fig:tds}
\end{figure}
