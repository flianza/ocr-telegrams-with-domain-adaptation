...
class BspModel(DomainAdaptationModel):
    def __init__(
        self, backbone, bottleneck_dim, lr, momentum, weight_decay, lr_gamma, lr_decay, trade_off, trade_off_bsp
    ):
        super().__init__(
            da_technique="bsp",
        ...
        self.bsp_penalty = BatchSpectralPenalizationLoss()
        ...
        self.trade_off_bsp = trade_off_bsp
    ...
    def training_step(self, batch, batch_idx):
        ...
        bsp_loss = self.bsp_penalty(f_s, f_t)
        domain_acc = self.domain_adv.domain_discriminator_accuracy
        loss = cls_loss + transfer_loss * self.trade_off + bsp_loss * self.trade_off_bsp
