...
from medgc_tesis.pipelines.modeling.models.vanilla import TargetOnlyModel
...
def optimize():
    ...
    study.optimize(_suggest_target_only, n_trials=defaults.OPTUNA_N_TRIALS)
...
def _fit_target_only(params, test):
    ...
    model = TargetOnlyModel(backbone=backbone, **params)
