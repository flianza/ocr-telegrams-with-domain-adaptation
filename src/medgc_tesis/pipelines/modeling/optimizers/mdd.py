...
from medgc_tesis.pipelines.modeling.models.mdd import MddModel
...
def optimize():
    ...
    study.optimize(_suggest_mdd, n_trials=defaults.OPTUNA_N_TRIALS)
...
def _fit_mdd(params, test):
    ...
    model = MddModel(backbone=backbone, **params)
